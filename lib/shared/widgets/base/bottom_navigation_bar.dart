        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildNavItem(index: 0, asset: 'assets/icons/house.png', route: AppRoutes.home),
                _buildNavItem(index: 1, asset: 'assets/icons/layout-grid.png', route: AppRoutes.categories),
                _buildNavItem(index: 2, asset: 'assets/icons/gift.png', route: AppRoutes.rewards),
                _buildNavItem(index: 3, asset: 'assets/icons/user.png', route: AppRoutes.profile),
              ],
            ),
          ],
        ),
